...
INSERT INTO users (first_name, last_name, role_id, email, user_password) VALUES
    ('John', 'Doe', 1, 'john.doe@example.com', 'password123'),
    ('Jane', 'Smith', 2, 'jane.smith@example.com', 'pass456'),
    ('Michael', 'Johnson', 3, 'michael.johnson@example.com', 'securePass'),
    ('Emily', 'Williams', 2, 'emily.williams@example.com', '123abc');

--Sample data for bug_lists
